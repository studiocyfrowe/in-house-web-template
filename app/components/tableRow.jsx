export default function TableRow({name, area, balcony, terrace, rooms, available}) {
    ...
    return (
        <tr className="uppercase">
            ...
            {balcony ? <td className="uppercase hover:bg-slate-400/20">{balcony} <span className="lowercase">m</span><sup>2</sup></td> : <td className="bg-green-400/35 hover:bg-green-400/25"></td>}
            {terrace ? <td className="uppercase hover:bg-slate-400/20">{terrace} <span className="lowercase">m</span><sup>2</sup></td> : <td className="bg-green-400/35 hover:bg-green-400/25"></td>}
